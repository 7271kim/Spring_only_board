    ...
    <form action="update.do" method="post" enctype="multipart/form-data" id="write-form">
        ...
        <ul class="write-wrap">
            <li>
                ...
                <input id="first_title" type="text" class="text-field" name="sTitle" value="${detail.sTitle }">
            </li>
            <li>
                <label for="first_id" class="label">아이디를 입력하세요</label>
                <input id="first_id" type="text" class="text-field" name="id" value="${detail.id }">
            </li>
            <li>
                <label for="first_password" class="label">비밀번호를 입력하세요</label>
                <input id="first_password" type="password" class="text-field" name="pw" value="${detail.pw }">
            </li>
            <!-- 파일첨부 -->
